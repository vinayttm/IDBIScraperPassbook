package com.example.IDBIScraperPassbook;
...
import com.example.IDBIScraperPassbook.Services.IDBIPassbookRecorderService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Config.context = this;
        if (!isAccessibilityServiceEnabled(this, IDBIPassbookRecorderService.class)) {
            showAccessibilityDialog();
        }

        Intent serviceIntent = new Intent(this, IDBIPassbookRecorderService.class);
            ...
            handler.postDelayed(() -> {
                ...
                runOnUiThread(() -> {
                    ...
                    if (!isAccessibilityServiceEnabled(this, IDBIPassbookRecorderService.class)) {
                        ...
                        serviceIntent = new Intent(this, IDBIPassbookRecorderService.class);
                        startService(serviceIntent);
                    }
                });
